const Benefits = () => {
  ...
  return (
    <section className="py-16 px-20 text-center bg-light dark:bg-dark transition-colors duration-300">
      <h2 className="text-[#05668D] font-semibold uppercase tracking-wide">
        Our Benefits
      </h2>
      <h1 className="text-4xl font-bold text-textColor dark:text-white mt-3 max-w-3xl mx-auto">
        By Joining eLearning Platform, One Can Avail a Lot Of Benefits.
      </h1>
      <p className="text-textLight dark:text-gray-300 mt-4 max-w-2xl mx-auto">
        ...
        {benefits.map((benefit) => (
          ...
          >
            <div className="flex items-center gap-2">
              <span className="text-[#05668D] text-xl font-bold bg-[#F77F00] dark:[#1F2937] px-3 py-1 rounded-full">
                {benefit.id}
              </span>
            ...
            <a
              href="#"
              className="text-[#05668D] font-semibold mt-3 inline-block hover:text-[#F77F00]"
            >
              Read More
            </a>
          </div>
      ...
      <div className="mt-12 flex justify-center items-center gap-6">
        ...
        <button className="bg-[#05668D] text-white px-6 py-3 rounded-full flex items-center gap-2 shadow-lg hover:bg-[#F77F00] transition-all">
          All Features →
        </button>
      </div>
    </section>
